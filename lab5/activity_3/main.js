...
function onCategoryChanged() {
    ...
    filterKey = category;
    updateChart(category, [0.00, 0.13]);
}
...
function updateChart(filterKey) {
    ...
    var filtered1 = filteredLetters.filter(function(e) {
        return e.frequency > min;
    });

    var filtered2 = filtered1.filter(function(e) {
        return e.frequency < max;
    });
